...
//    //SQL injection with normalStatement(this may cause problems when working with the database
//    // so is better to use preparedStatement)
//        @Override
...
//SQL injection withPreparedStatement
    @Override
    public Beer getByName(String name) {
        String query = "select beer_id, name, abv " +
                "from beers " +
